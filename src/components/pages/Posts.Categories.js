...
import CreateNewPostCategory from "../subComponents/CreateNewPostCategory";
...
const PostsCategories = () => {
  ...
  return (
    <div className={"general-table-view"}>
      {postEditor ? (
        <CreateNewPostCategory backToCategories={switchCreateNewPostScreen} />
      ) : (
        <div className={"posts"}>
          <div className={"create-post"}>
            <Header1 title={"Posts · Categories"} />
